...
namespace Property_Rental_Management.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentID,DateAndTime,Description,UserID")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentID,DateAndTime,Description,UserID")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
